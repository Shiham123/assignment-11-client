const FooterSection = () => {
  return (
    <div>
      <footer className="footer footer-center p-10 bg-colorThree rounded-lg text-colorFive">
        <aside>
          ...
          <p className="font-poppins text-2xl font-bold tracking-widest">
            Providing reliable tech since 1992
          </p>
          <p className="font-poppins font-semibold text-xl py-4">
